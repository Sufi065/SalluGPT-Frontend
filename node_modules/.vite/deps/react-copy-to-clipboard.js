...
var require_Component = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	_defineProperty(exports.CopyToClipboard = /* @__PURE__ */ function(_React$PureComponent) {
		function CopyToClipboard() {
			...
			_defineProperty(_this, "onClick", function(event) {
				...
				if (elem !== null && elem !== void 0 && elem.props && typeof elem.props.onClick === "function") elem.props.onClick(event);
			});
			return _this;
		}
	...
	}(_react["default"].PureComponent), "defaultProps", {
		onCopy: void 0,
		options: void 0
	});
}));
//#endregion
//#region node_modules/react-copy-to-clipboard/lib/index.js
